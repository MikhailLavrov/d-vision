...
export const updateInventoryThunk = (id, count, name) => (dispatch) => {
  return companyAPI.updateInventory(id, count, name)
    .then(() => {
      dispatch(updateInventory({id: id, count: count, name: name}));
    });
};
